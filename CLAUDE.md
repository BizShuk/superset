...
| `src/cliLauncher/` | 獨立「CLI」面板：掃描兩層 Git repositories、支援 explicit paths 與 subsequence 路徑過濾、每列顯示 git 分支與行數增減，三顆按鈕在該路徑開 terminal 跑 claude / codex / grok | `cliLauncherPlugin` |
